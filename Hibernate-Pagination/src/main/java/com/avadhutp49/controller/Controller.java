...
import com.avadhutp49.service.InsurancePolicyService;
import com.avadhutp49.service.InsurancePolicyServiceImpl;
...
public class Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (value.equalsIgnoreCase("generatereport")) {
			...
			String ip =request.getParameter("pageSize");
			if(ip=="" || ip.isEmpty()) {
				pageSize=0;
			}else {
				pageSize = Integer.parseInt(ip);
